...
export default async function MenteeTableComponent(props: Props) {
  ...
  const messageToMentor = props.messageToMentor;
  return (
            ...
            <div className="collapse-content">
              <div>
                        ...
                        <td>
                          <p className="tablefont-custom-primary">
                            {uniBackground.subjectOneName.length > 40
                              ? `${uniBackground.subjectOneName.slice(
                                  0,
                                  40,
                                )}...`
                        ...
                        <td>
                          <p className="tablefont-custom-primary">
                            {uniBackground.subjectTwoName.length > 40
                              ? `${uniBackground.subjectTwoName.slice(
                                  0,
                                  40,
                                )}...`
                ...
                <div className="chat chat-end">
                  ...
                  <div className="chat-bubble">{messageToMentor}</div>
                </div>
              </div>
              {props.children}
            </div>
