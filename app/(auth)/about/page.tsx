                ...
                <div className="lg:pr-4">
                  <div className="lg:max-w-lg">
                    <p className="text-base font-semibold leading-7 text-indigo-600">
                      Tackle university admissions inequality with us{' '}
                    </p>
                    <h1 className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
                      Become a mentor !{' '}
                    </h1>
                    <p className="mt-6 text-xl leading-8 text-gray-700">
                      Volunteer to become a mentor at Project Access and help
                      less privileged students to attend the university of their
                      dreams.
                    </p>
                  </div>
                </div>
              ...
              <div className="lg:col-span-2 lg:col-start-1 lg:row-start-2 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
                <div className="lg:pr-4">
                  <div className="max-w-xl text-base leading-7 text-gray-700 lg:max-w-lg">
                    ...
                    <p className="mt-6">
                      The core of the Project Access Program is one-on-one
                      mentoring between less privileged applicants and current
                      top university students. You will be paired with a mentee
                      - ideally from your country/region - who is interested in
                      studying a degree similar to yours at your university. 1-2
                      hours a month of your support can have great impact.
                    </p>
                    <p className="mt-6">
                      As a mentor, you provide applicants with encouragement,
                      application support and tips and tricks throughout the
                      application process. Why you should become a mentor Are
                      you considering to volunteer as a mentor at Project
                      Access? We offer you a unique opportunity to develop
                      professionally and have a positive impact on equality and
                      social mobility.
                    </p>
                    <ul className="mt-8 space-y-8 text-gray-600">
                      <li className="flex gap-x-3">
                        ...
                        <span>
                          ...
                          You can change your mentee’s lives! Imagine the
                          support you wish you had when you decided where to
                          study or how to write your personal statement. With
                          your experience you can help your mentees succeed
                        </span>
                      </li>
                      <li className="flex gap-x-3">
                        <svg
                        ...
                        <span>
                          ...
                          You can join a team of more than 5,000 mentors who
                          study at some of the world’s best universities. We
                          host regular campus events where you get to meet
                          inspiring students and make new friends
                        </span>
                      </li>
                      <li className="flex gap-x-3">
                        <svg
                        ...
                        <span>
                          ...
                          We provide training and resources for you to help your
                          mentee succeed. You’ll learn and practice time
                          management, interpersonal skills, and we help you to
                          develop professionally by connecting you with partners
                        </span>
                      </li>
                    </ul>
                    <h2 className="mt-16 text-2xl font-bold tracking-tight text-gray-900">
                      What are you waiting for? Become a mentor now!{' '}
                    </h2>
                    <p className="mt-6">
                      “Being a mentor is one of the most rewarding ‘jobs’ you
                      can think of. To help people realize their full potential
                      and succeed at their dreams is a great way of giving back
                      and advance the cause of equal opportunity and access in
                      education.” Katharina from Austria, Environmental policy
                      with economics @ LSE
                    </p>
                    <p className="mt-6">
                      “Applying to top universities independently is not an easy
                      thing, emotionally nor practically. Being able to support
                      my mentees and pass on my own learnings from applying is
                      great, and their gratitude is worth every effort.” Oliver
                      from Denmark, Man… “Applying to top universities
                      independently is not an easy thing, emotionally nor
                      practically. Being able to support my mentees and pass on
                      my own learnings from applying is great, and their
                      gratitude is worth every effort.” Oliver from Denmark,
