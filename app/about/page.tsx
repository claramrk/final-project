                  ...
                  <div className="lg:pr-4">
                    <div className="lg:max-w-lg">
                      ...
                      <p className="mt-6 text-xl leading-8 text-gray-700">
                        ...
                        less privileged students to attend the university of
                        their dreams.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="lg:pr-4">
                    <div className="max-w-xl text-base leading-7 text-gray-700 lg:max-w-lg">
                      ...
                      <p className="mt-6">
                        ...
                        top university students. You will be paired with a
                        mentee - ideally from your country/region - who is
                        interested in studying a degree similar to yours at your
                        university. 1-2 hours a month of your support can have
                        great impact.
                      </p>
                      <p className="mt-6">
                        ...
                        professionally and have a positive impact on equality
                        and social mobility.
                      </p>
                      <ul className="mt-8 space-y-8 text-gray-600">
                        ...
                        <li className="flex gap-x-3">
                          ...
                          <span>
                            ...
                            We provide training and resources for you to help
                            your mentee succeed. You’ll learn and practice time
                            management, interpersonal skills, and we help you to
                            develop professionally by connecting you with
                            partners
                          </span>
                        </li>
                      </ul>
                      ...
                      <p className="mt-6">
                        ...
                        can think of. To help people realize their full
                        potential and succeed at their dreams is a great way of
                        giving back and advance the cause of equal opportunity
                        and access in education.” Katharina from Austria,
                        Environmental policy with economics @ LSE
                      </p>
                      <p className="mt-6">
                        “Applying to top universities independently is not an
                        easy thing, emotionally nor practically. Being able to
                        support my mentees and pass on my own learnings from
                        applying is great, and their gratitude is worth every
                        effort.” Oliver from Denmark, Man… “Applying to top
                        universities independently is not an easy thing,
                        emotionally nor practically. Being able to support my
                        mentees and pass on my own learnings from applying is
                        great, and their gratitude is worth every effort.”
